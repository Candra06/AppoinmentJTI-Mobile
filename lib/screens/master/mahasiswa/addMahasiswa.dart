        ...
        child: Container(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                konstan().buildFormField('Nama Lengkap', 'Masukkan nama mahasiswa', txtName, TextInputType.text),
                SizedBox(
                  height: 12,
                ),
                konstan().buildFormField('NIM', 'Masukkan NIM mahasiswa', txtNIM, TextInputType.text),
                SizedBox(
                  height: 8,
                ),
                ...
                konstan().buildFormField('Email', 'Masukkan email mahasiswa', txtEmail, TextInputType.emailAddress),
                SizedBox(
                  height: 12,
                ),
